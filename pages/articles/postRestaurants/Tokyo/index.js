...
import style from "../../postLieux/ville.module.css";
import Link from "next/link";

export default function Index({ data }) {
    const filteredPosts = data.filter((e) => e.localisation === "Tokyo" && e.tag === "nourriture");

    return (
        <div>
            <h1 className={style.titre}>Les meilleurs gyozas de Tokyo</h1>
